CREATE TABLE buckets_blog.customer
(
...
CLUSTERED BY (c_customer_sk) INTO 100 BUCKETS
STORED AS PARQUET
LOCATION 's3://<s3bucket>/buckets_blog/customer';

CREATE TABLE buckets_blog.store_sales
(
...
CREATE TABLE buckets_blog.store_returns
(
